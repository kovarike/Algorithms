        ...
        <div className="my-0 mx-auto mx-full p-6 bg-white text-slate-800" id={id} >
          ...
          >
            ...
            <div className="text-center mx-auto space-y-4 w-auto max-w-auto">
              ...
              <h2 className="text-gray-600 text-xl font-algorithms-font font-medium ">
                Computer Engineer
              </h2>
            </div>
            <Translate id={id} />
          ...
          <div className="flex items-center justify-center space-y-2 mx-auto mb-4">
            <Link href="https://www.linkedin.com/in/danilokovarike/">
              <Img width={60} height={60} src={social_media.linkedin} alt="linkedin" />
            </Link>

            <Link href="https://www.github.com/kovarike/">
              <Img width={60} height={60} src={social_media.github} alt="gitub" />
            </Link>
            <Link href="https://www.instagram.com/usdanilo/">
              <Img width={60} height={60} src={social_media.whatsapp} alt="whatsapp" />
            </Link>

            <Link href="https://www.instagram.com/usdanilo/">
              <Img width={60} height={60} src={social_media.instagram} alt="intagram" />
            </Link>
            <Link href="https://www.github.com/kovarike/">
              <Img width={60} height={60} src={social_media.email} alt="email" />
            </Link>
          </div>
          ...
          <div className="mx-auto mt-2 overflow-hidden space-x-1 border-b border-slate-500">
            <div className="flex items-center justify-center mb-4">
              <Img width={300} height={100} src={profile.github} alt="github" />
            </div>
          </div>
        </div>
        <Footer />
